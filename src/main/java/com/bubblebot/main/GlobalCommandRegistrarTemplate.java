...
public class GlobalCommandRegistrarTemplate {
//  private final Logger LOGGER = LoggerFactory.getLogger(this.getClass());

  private final RestClient restClient;

  public GlobalCommandRegistrarTemplate(RestClient restClient) {
...
//        LOGGER.info("Updated global command: " + command.name());
  ...
  private static List<String> getCommandsJson() throws IOException {
    ...
    URL url = GlobalCommandRegistrarTemplate.class.getClassLoader().getResource(commandsFolderName);
